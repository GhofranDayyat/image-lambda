...
//Subclass gm to enable ImageMagick integration
const gm  = require('gm').subClass({imageMagick:true}); //to resize img

//This implements the Node.js util module for environments that do not have it, like browsers.
const util = require('util')  //If your code runs in Node.js, util is built in. 
